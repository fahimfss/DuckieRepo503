...
class LaneFollowNode(DTROS):
    ...
    def __init__(self, node_name):
        ...
        self.sub = rospy.Subscriber("/" + name + "/april_tag_id",
                                    Int32,
                                    self.callback_at,
                                    queue_size=1)
        
        self.car_status_pub = rospy.Publisher("/" + name + "/car_status",
                                       Float32,
                                       queue_size=1)
    ...
    def controller(self): 
        ...
        if self.id_num == 94:
            ...
            self.id_num = 0
            self.velocity = 0.2
            #self.car_status_pub(self.status_num)
        # elif self.id_num in [93, 94, 200, 201]:
        #     print("driving1")
        #     self.status_num = 1
        #     #self.car_status_pub(self.status_num)
        #     self.drive()
        elif self.id_num == 143 or self.id_num == 62:
            self.stop(1.5)
            self.straight(self.id_num)
            self.id_num = 0
        elif self.id_num == 169 or self.id_num == 58:
            # print("right")              
            self.stop(1.5)
            self.right(self.id_num)
            self.id_num = 0
        elif self.id_num == 153 or self.id_num == 162:
            # print("left")               
            self.stop(1.5)
